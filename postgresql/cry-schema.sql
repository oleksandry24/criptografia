...
--                    description)
--        values('Web Database Development : Step by Step', 'Jim Buyens', 'Databases',  39.99, '2022-01-01 12:00:00', 'Web; persistence; sql', 'This is a very nice book.', 10,
...
-- insert into books (title, authors, category, price, book_date, keywords, notes, recomendation,
--                    description)
--        values('Programming Perl (3rd Edition)', 'Larry Wall, Tom Christiansen, Jon Orwant', 'Programming',  39.96, '2023-12-01 12:00:00', 'Perrl; scripts; code', 'This is a very nice book.', 9, 
...
-- insert into books (title, authors, category, price, book_date, keywords, notes, recomendation,
--                    description)
--        values('Perl and CGI for the World Wide Web: Visual QuickStart Guide', 'Elizabeth Castro', 'Programming',  15.19, '2023-06-01 12:00:00', 'Perral; scripts; code', 'This is a very nice book.', 18, 
...
-- insert into books (title, authors, category, price, book_date, keywords, notes, recomendation,
--                    description)
--        values('Teach Yourself ColdFusion in 21 Days (Teach Yourself -- 21 Days)', 'Charles Mohnike', 'HTML & Web design',  31.99, '2023-06-01 12:00:00', 'Client; scripts; code', 'This is a meager book.', 1, 
...
-- insert into books (title, authors, category, price, book_date, keywords, notes, recomendation,
--                    description)
--        values('ColdFusion Fast & Easy Web Development', 'T. C., III Bradley', 'HTML & Web design',  31.99, '2023-06-01 12:00:00', 'Cold; scripts; code', 'This is a meager book.', 1, 
